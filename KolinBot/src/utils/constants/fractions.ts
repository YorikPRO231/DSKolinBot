...
export function factionByDiscordID(discord_id: string | undefined): [FractionType, {
    label: string, discord_id: string, state: boolean , emoji_id: string, chp_role_id : string, faction_role_id: string }] {
    if (!discord_id) {
